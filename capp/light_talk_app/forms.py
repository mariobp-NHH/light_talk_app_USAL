...
class YourSentencesForm(FlaskForm):
  objective = SelectField('Objetivo', [InputRequired()], 
    choices=[('Genero', 'Genero'), ('Número', 'Número'), ('Todos', 'Todos')])
  source = SelectField('Fuente', [InputRequired()], 
    choices=[('Inteligencia Artificial', 'Inteligencia Artificial'), ('Persona', 'Persona'), ('Lingüista', 'Lingüista'), ('Todas', 'Todas')])
  submit = SubmitField('Seleccionar')
